<footer class="footer">
        ...
        <div class="container footer-grid">
            <div class="footer-brand">
                <div class="footer-logo">
                    <img src="{{ asset('logo.png') }}" alt="IT Support Jabodetabek Logo" class="footer-logo-img" />
                    <div>
                        <div class="footer-logo-name">IT Support</div>
                        <div class="footer-logo-sub">Jabodetabek</div>
                    </div>
                </div>
                <p class="footer-desc">
                ...
                <div class="footer-socials">
                    {{-- Facebook --}}
                    <a href="#" class="social-btn social-btn--fb" aria-label="Facebook" title="Facebook">
                        <svg viewBox="0 0 24 24" fill="currentColor" width="17" height="17">
                            <path d="M24 12.073C24 5.404 18.627 0 12 0S0 5.404 0 12.073C0 18.1 4.388 23.094 10.125 24v-8.437H7.078v-3.49h3.047V9.41c0-3.025 1.792-4.697 4.533-4.697 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.93-1.956 1.874v2.25h3.328l-.532 3.49h-2.796V24C19.612 23.094 24 18.1 24 12.073z"/>
                        </svg>
                    </a>
                    {{-- Instagram --}}
                    <a href="https://www.instagram.com/pt.itsupportjabodetabek?igsh=aDR0NXJ1ZGJpamNz&utm_source=qr" target="_blank" rel="noopener noreferrer" class="social-btn social-btn--ig" aria-label="Instagram" title="Instagram">
                        <svg viewBox="0 0 24 24" fill="currentColor" width="17" height="17">
                    ...
                    {{-- LinkedIn --}}
                    <a href="https://www.linkedin.com/in/pt-info-tech-support-jabodetabek-3313a9410" target="_blank" rel="noopener noreferrer" class="social-btn social-btn--li" aria-label="LinkedIn" title="LinkedIn">
                        <svg viewBox="0 0 24 24" fill="currentColor" width="17" height="17">
                            <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                        </svg>
                    </a>
                    {{-- WhatsApp --}}
                    <a href="https://wa.me/6281210874692" target="_blank" rel="noreferrer" class="social-btn social-btn--wa" aria-label="WhatsApp" title="Chat WhatsApp">
                        <svg viewBox="0 0 24 24" fill="currentColor" width="17" height="17">
            ...
            <div class="footer-col">
                ...
                <a href="https://wa.me/6281210874692" target="_blank" rel="noreferrer" class="footer-wa-btn">
    ...
    <div class="footer-bottom">
        <div class="container footer-bottom-inner">
            <p>&copy; {{ date('Y') }} IT Support Jabodetabek. All rights reserved.</p>
